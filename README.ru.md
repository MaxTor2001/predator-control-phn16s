...
Демон даёт +15 Вт и +12 % частоты; на этой нагрузке, ограниченной ещё и памятью, это +5 % скорости.
Игры и лимит в режимах Performance/Turbo не измерялись; постоянная установка демона не сделана.
