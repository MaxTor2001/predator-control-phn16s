...
Не закончено. У RTX 5070 Laptop лимит мощности по умолчанию 70 Вт при максимуме 115 Вт;
...
Демон работает и поднимает лимит, но тестовый шейдер сам потребляет только ~65 Вт и в лимит не упирается,
поэтому прирост производительности пока не доказан. Нужен замер нагрузкой, ограниченной мощностью
(игра), и в режимах Performance/Turbo.
